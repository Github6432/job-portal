...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="px-4 py-3 dark:bg-gray-900 bg-opacity-90 shadow-lg fixed top-0 left-0 w-full z-50 transition-shadow duration-300 ease-in-out">
            <div className="container mx-auto px-6 flex items-center justify-between">
                ...
                <ul className="hidden md:flex justify-center bg-gray-900 items-center space-x-4">
                    <Link href="/">
